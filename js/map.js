...
$(function () {
	...
	function initroomMap() {
		...
		var iconBase = '../img/maps/pin-dark.png';
		...
		var markers = [
			{
				...
				iconImage: '../img/maps/pin-white.png',
				content: `
                    <div class="map-info-window">
                        <div class="info-window-img" style="background-image: url(img/maps/place-1.jpg);">
                        </div>
			...
			},
			{
				...
				content: `
                    <div class="map-info-window">
                        <div class="info-window-img" style="background-image: url(img/maps/place-2.jpg);">
                        </div>
                        <div class="info-content">
                            <h4>Duplex Restaurant</h4>
                            <p> 1,500m | 21 min. Walk </p>
			...
			},
			{
				...
				content: `
                    <div class="map-info-window">
                        <div class="info-window-img" style="background-image: url(img/maps/place-3.jpg);">
                        </div>
                        <div class="info-content">
                            <h4>Duplex Restaurant</h4>
                            <p> 1,500m | 21 min. Walk </p>
			...
			},
			{
				...
				content: `
                    <div class="map-info-window">
                        <div class="info-window-img" style="background-image: url(img/maps/place-4.jpg);">
                        </div>
                        <div class="info-content">
                            <h4>Duplex Restaurant</h4>
                            <p> 1,500m | 21 min. Walk </p>
